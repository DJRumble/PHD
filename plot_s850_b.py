...
s850 = aplpy.FITSFigure('maps/fits_files/coadd_serpensmain_s850_th_north.fits')
s850.show_colorscale(cmap='gist_heat',vmax=1,vmin=-0.1,stretch='sqrt')
a = np.arange(0,10,1.0)
clevels = 0.02*5.0**a
print clevels
s850.show_contour('maps/fits_files/coadd_serpensmain_s850_th_north.fits',levels=clevels, colors="black")
