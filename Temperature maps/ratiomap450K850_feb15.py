...
#1) Structuring of directories. Structuring is in order of: Method/map/region/files.sdf. Maths folder is generla and is deleted later.
...
Temp_error =  output_dir+'/'+method+'/map/'+file+'/'+file+'temp_error.sdf' #maps of error in temp
