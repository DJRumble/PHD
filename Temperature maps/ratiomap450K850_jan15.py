...
input_dir = 'input/maps/quick_maps/'
#input_dir = 'input'
output_dir = 'output'
...
cmd = 'mv %s %s'%('s450convolve.sdf',output_dir+'/process/'+file)
os.system(cmd)
...
if method == 'D':
    ...
    print 'Kernel Method' 
    K450 = output_dir+'/process/'+file+'/s450convolve.sdf'
...
os.system(cmd)
cmd1 = '%s/mult in1=%s in2=%s out=%s QUIET'%(kapdir,s450align,output_dir+'/process/'+file+'/s450readymask.sdf',output_dir+'/process/'+file+'/s450alignTH.sdf')
cmd2 = '%s/mult in1=%s in2=%s out=%s QUIET'%(kapdir,s850collapse,s850mask,output_dir+'/process/'+file+'/s850collapseTH.sdf')
os.system(cmd1)
os.system(cmd2)
...
s450 = output_dir+'/process/'+file+'/s450alignTH.sdf' #maps of constant flux
s850 = output_dir+'/process/'+file+'/s850collapseTH.sdf' #maps of constant flux
