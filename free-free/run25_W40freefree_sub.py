...
mv1 = 'mv maps/temp/map450v%s.sdf maps/pointsourcemap450comb_v2.sdf'%(i+2)
mv2 = 'mv maps/temp/map850v%s.sdf maps/pointsourcemap850comb_v2.sdf'%(i+2)
os.system(mv1)
os.system(mv2)
...
in450 = 'maps/pointsourcemap450comb_v2.sdf'
in850 = 'maps/pointsourcemap850comb_v2.sdf'
...
sub1='%s/sub in1=%s in2=%s out=%s'%(kapdir,s450,'maps/s450freefree_comb.sdf','maps/Aquila_extS2nosm_s450-4am-fullfreefree_v2.sdf')
sub2='%s/sub in1=%s in2=%s out=%s'%(kapdir,s850,'maps/s850freefree_comb.sdf','maps/Aquila_noco_extS2nosm_s850-4am-fullfreefree_v2.sdf')
os.system(sub1)
os.system(sub2)
