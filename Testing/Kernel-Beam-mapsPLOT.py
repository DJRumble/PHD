...
convolve450 = '/data/damian/temp_MKR/output/kernel/process/SerpensMain_20141223-auto/s450convolve.fits'
align450 = '/data/damian/temp_MKR/output/kernel/process/SerpensMain_20141223-auto/gas450align.fits'
thresh450 = '/data/damian/temp_MKR/output/kernel/process/SerpensMain_20141223-auto/s450alignTH.fits'

input850 = '/data/damian/maps/serpens/serpensmain/IR2/SerpensMain_20141223_s850_IR2extmask_s2_cal_JypixJH.fits'
convolve850 = '/data/damian/maps/serpens/serpensmain/IR2/SerpensMain_20141223_s850_IR2extmask_s2_cal_JypixJH.fits'
align850 = '/data/damian/maps/serpens/serpensmain/IR2/SerpensMain_20141223_s850_IR2extmask_s2_cal_JypixJH.fits'
thresh850 = '/data/damian/temp_MKR/output/kernel/process/SerpensMain_20141223-auto/s850collapseTH.fits'
...
Fig2.add_label(0.3, 0.9, r'450$\mathrm{\mu} m$ K-Convolve', relative=True)
...
Fig2.add_label(0.3, 0.9, r'850$\mathrm{\mu} m$ Input', relative=True)
Fig3.add_label(0.3, 0.9, r'850$\mathrm{\mu} m$ Input', relative=True)
