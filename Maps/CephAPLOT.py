...
s850 = 's850/Cepheus_South_20150225_850_IR2_noco_HKJypix_col.fits'
temp = 'temperature/Cepheus_South-autotemperature.fits'
clumpcat = 'FW/cat/Cepheus_South_20150225_clump_cat.fit'
clumps = 'FW/clumps/Cepheus_South_20150225_clumps.sdf'
proto = 'YSO/surface/Cepheus_South_proto_surface_r300_units.fits'
pms = 'YSO/surface/Cepheus_South_PMS_surface_r300_units.fits'
CD = 'CDmaps/Cepheus_South_CDcomb.fits'

sig850 = 0.0041

pos1 = [315.345416667,68.1375833333,0.1,0.2] #L1174/72
pos2 = [311.567083333,67.9453333333,0.05,0.05] #L1155
pos3 = [309.385833333,67.9500555556,0.2,0.2] #L1152/57
...
#Label
Fig3.add_label(0.15, 0.9, 'L1152/57', relative=True)
Fig2.add_label(0.15, 0.9, 'L1155', relative=True)
Fig1.add_label(0.15, 0.9, 'L1174/72', relative=True)

Fig1.add_label(0.35, 0.55, 'HD 200775', relative=True)
...
#Add Scale Bar (1pc)
Fig1.add_scalebar(358 * u.arcsecond,label=('0.5 pc'),corner=('bottom left'))
Fig2.add_scalebar(358 * u.arcsecond,label=('0.5 pc'),corner=('bottom left'))
Fig3.add_scalebar(358 * u.arcsecond,label=('0.5 pc'),corner=('bottom left'))
...
for j in DATA:
    ...
    mask = 'mask/mask_Cepha_'+str(I)+'.sdf'
    maskFITS = 'mask/mask_Cepha_'+str(I)+'.fits'
...
print 'saving map as: '+str('plots/%s_Cepha.pdf'%(date))
savefig('plots/%s_Cepha.pdf'%(date))
