...
s850 = 's850/SerpensE_20141219_s850_IR2extmask_s2_cal_JypixJH_col.fits'
temp = 'temperature_maps/SerpensE_20141219-autotemperature.fits'
clumpcat = 'FW/cat/SerpensE_20141219_sclump_cat_v2.fit'
clumps = 'FW/clumps/SerpensE_20141219_sclumps_v2.sdf'
proto = 'YSO/surface/SerpensE_proto_surface_r300_units.fits'
pms = 'YSO/surface/SerpensE_PMS_surface_r300_units.fits'
CD = 'CDmaps/SerpensE_CDcomb.fits'

sig850 = 0.0025

pos1 = [279.6525,-1.15777777778,0.2,0.2] 
pos2 = [279.150833333,-1.20608333333,0.10,0.10] 
pos3 = [279.5075,-1.71775,0.18,0.18] 
...
#Label
Fig3.add_label(0.15, 0.9, 'East 1', relative=True)
Fig2.add_label(0.15, 0.9, 'East 2', relative=True)
Fig1.add_label(0.15, 0.9, 'East 3', relative=True)
...
Fig3.add_scalebar(412 * u.arcsecond,label=('0.5 pc'),corner=('bottom left'))
...
print 'saving map as: '+str('plots/%s_SerpEast1.pdf'%(date))
savefig('plots/%s_SerpEast1.pdf'%(date))
