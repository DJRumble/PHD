...
####################################################
#plot bakground map - subtitute in as appropriate 

south='serpens_south/coadd_aquila_850_u20_cal556_th.fits'
mwc='MWC297/serpensmwc297_s850_ext_mask2_cal537_mos_th.fits'
main='serpensmain/serpensmain_s850_ext_mask_cal537_mos_v2_th.fits'
E1='serpens_E1/serpensE1_s850_ext_mask1_cal537_mos_th.fits'

s850 = aplpy.FITSFigure(south)

#####################################################################
#show contours

s850.show_contour(south, colors=('blue'),levels=(0.03,0.3),linestyles=('dotted','solid'))
