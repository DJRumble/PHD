...
def comb_M(m1,m2):
    ...
    #print M850
    ###15K cloud
    S15_450 = (BB(l450,10)*M450*m1*kappa_4)/(d**2.)
    S15_850 = (BB(l850,10)*M850*m1*kappa_8)/(d**2.)
    ### TK cloud with fraction f
    STf_450 = (BB(l450,30)*M450*m2*kappa_4)/(d**2.)
    STf_850 = (BB(l850,30)*M850*m2*kappa_8)/(d**2.)
    #Sum
    c450 = S15_450 + STf_450
    c850 = S15_850 + STf_850
    #print round(c450,1),round(c850,1)
...
f = np.arange(0.00,1,0.01)

SR = [comb_M(1-i,i) for i in f]
...
plt.plot(f,SR,'k',linestyle='-',linewidth=1)


#plt.annotate('20K',xy=(0.2,0.1))


plt.annotate('RATIO = 6 (~15K)',xy=(0.05,0.15))

plt.axvline(x=(0.5),linestyle='-.',color='k')
plt.axvline(x=(0.517),linestyle=':',color='k')
...
plt.xlabel(r"'Warm' (20K) to 'cool' (10K) cloud mass ratio")
