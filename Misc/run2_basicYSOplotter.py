...
s850 = aplpy.FITSFigure('serpensmain_s450_ext_mask_cal491_mos_v2_th.fits')
...
ra,dec = data[:,1], data[:,2]
s850.show_markers(ra,dec, layer='cFS', edgecolor='magenta',facecolor='magenta',marker='o',s=50, alpha=0.4)
